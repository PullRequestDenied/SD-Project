...
const AccountInfoComponent = () => {
  ...
  return (
    <section className="flex justify-center transition-colors">
      <article
        className={`relative z-10 w-xl px-6 py-12 rounded-md transition-all duration-300 ease-in-out border border-transparent hover:border-indigo-400 ${
          darkMode
      ...
      >
        ...
        <form className="space-y-4">
          ...
          <footer className="flex flex-col justify-between items-end">
            {edit ? (
              <button
